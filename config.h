...
static const char *const autostart[] = {
    "pipewire", NULL, "mako", NULL, NULL /* terminate */
};
...
static const Key keys[] = {
    ...
    { MODKEY, XKB_KEY_e, spawn, SHCMD ("goneovim") },
    { MODKEY | WLR_MODIFIER_SHIFT, XKB_KEY_D, spawn, SHCMD ("flameshot gui") },
    { MODKEY | WLR_MODIFIER_SHIFT, XKB_KEY_S, spawn, SHCMD ("waylock") },
    { MODKEY | WLR_MODIFIER_SHIFT | WLR_MODIFIER_CTRL, XKB_KEY_S, spawn,
      SHCMD ("loginctl suspend") },
